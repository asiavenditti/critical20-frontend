    ...
    return (
        <div className="about-lg">
            ...
            <section className="hero-banner">
                ...
                <p className="subtitle">Un team di sviluppatori con la passione per i giochi da tavolo.</p>
            ...
            <section className="about-content">
                ...
                <div className="text-container">
                    <h2>Critical Dev</h2>
                    <p>
                        Dopo innumerevoli serate passate tra dadi, meeple e carte, ci siamo chiesti: perché non trasformare questa passione in qualcosa di concreto?<br /><br />
                        Così è nato il nostro progetto: un <strong>e-commerce dedicato ai giochi da tavolo</strong>, pensato per offrire ai giocatori di ogni tipo un punto di riferimento semplice, curato e creato da chi davvero ama questo mondo.<br /><br />
                        <strong>Prima di essere dev, siamo giocatori</strong>
                        <br></br>  e ora.. vogliamo condividere questa passione con tutti voi.
                    </p>
                </div>
            </section>
        </div>
